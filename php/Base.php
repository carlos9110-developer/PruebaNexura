...
class Base
{
    private $dbDriver = 'mysql'; //Tipo de motor de base de datos
    private $dbHost   = 'localhost'; //Servidor de bas de datos
    private $dbUser   = 'root'; //Usuarios de la base de datos
    private $dbName   = 'nexura'; //Nombre de la base de datos
    ...
    public function __construct($charset = false)
    {
        ...
        try {
            ...
            echo "<div class='alert alert-danger alert-dismissible' role='alert'>
                  <strong>Error!</strong> Se detecto que hay algún problema en la conexión. " . $e->getMessage() . " </div>";
        }
    }
